...
@section('addcontent')
    ...
    <div class="bg-slate-100 shadow-lg ">
        <div class="container mx-auto  p-8 max-w-6xl ">
            <h1 class="text-2xl font-semibold mb-6 text-[#2a3844]">Add Property</h1>
            ...
            <form id="propertyForm" action="{{ route('storeProperty') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="title" class="block text-md font-semibold text-[#374958] ">Property Title:<sup
                                class="text-red-500 text-md ">*</sup> </label>
                    ...
                    <div>
                        <label for="status" class="block text-md font-semibold text-[#374958]">Status:<sup
                                class="text-red-500 text-md ">*</sup></label>
                        <select id="status" name="status"
                            ...
                            <<option value="" disabled
                                {{ old('status', $property->status ?? '') == '' ? 'selected' : '' }}>Select Status</option>
                                <option value="for_rent"
                                    {{ old('status', $property->status ?? '') == 'for_rent' ? 'selected' : '' }}>For Rent
                                </option>
                                <option value="for_sale"
                                    {{ old('status', $property->status ?? '') == 'for_sale' ? 'selected' : '' }}>For Sale
                                </option>
                        </select>
                    </div>
                </div>
                ...
                <div id="rentFields" class="hidden mb-6">
                    <label for="rentPrice" class="block text-md font-semibold text-[#374958]">Monthly Rent Price:</label>
                    <div class="relative">
                ...
                <div id="saleFields" class="hidden mb-6">
                    <label for="salePrice" class="block text-md font-semibold text-[#374958]">Sale Price:</label>
                    <div class="relative">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3 text-gray-500">NPR</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="property_type" class="block text-md font-semibold text-[#374958]">Property Type:<sup
                                class="text-red-500 text-md ">*</sup></label>
                        <select id="property_type" name="property_type"
                            ...
                            <option value="" disabled selected
                                {{ old('status', $property->status ?? '') == '' ? 'selected' : '' }}>Select Property Type
                            </option>
                            <option value="house"
                    ...
                    <div id="houseFields" class="hidden">
                        <label for="house_category" class="block text-md font-semibold text-[#374958]">House Category:<sup
                                class="text-red-500 text-md ">*</sup></label>
                        <select id="house_category" name="house_category"
                            ...
                            <option value="" disabled {{ old('house_category') == '' ? 'selected' : '' }}>Select
                                House Category</option>
                            <option value="2bhk" {{ old('house_category') == '2bhk' ? 'selected' : '' }}>2BHK</option>
                            <option value="duplex" {{ old('house_category') == 'duplex' ? 'selected' : '' }}>Duplex
                            </option>
                            <option value="bungalow" {{ old('house_category') == 'bungalow' ? 'selected' : '' }}>Bungalow
                            </option>
                            ...
                            <option value="triplex" {{ old('house_category') == 'triplex' ? 'selected' : '' }}>Triplex
                            </option>
                            <option value="others" {{ old('house_category') == 'others' ? 'selected' : '' }}>Others
                            </option>
                        </select>
                    ...
                    <div id="apartmentFields" class="hidden">
                        <label for="apartment_name" class="block text-md font-semibold text-[#374958]">Apartment
                            Name:</label>
                        ...
                        <label for="apartment_category" class="block text-md font-semibold text-[#374958] mt-4">Apartment
                            Category:<sup class="text-red-500 text-md ">*</sup></label>
                        <select id="apartment_category" name="apartment_category"
                            class="mt-1 block w-full p-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            <option value="" disabled {{ old('apartment_category') == '' ? 'selected' : '' }}>Select
                                Apartment Category</option>
                            <option value="studio" {{ old('apartment_category') == 'studio' ? 'selected' : '' }}>Studio
                            </option>
                            <option value="2bhk" {{ old('apartment_category') == '2bhk' ? 'selected' : '' }}>2BHK
                            </option>
                            <option value="3bhk" {{ old('apartment_category') == '3bhk' ? 'selected' : '' }}>3BHK
                            </option>
                            <option value="duplex" {{ old('apartment_category') == 'duplex' ? 'selected' : '' }}>Duplex
                            </option>
                            <option value="4bhk" {{ old('apartment_category') == '4bhk' ? 'selected' : '' }}>4BHK
                            </option>
                            <option value="penthouse" {{ old('apartment_category') == 'penthouse' ? 'selected' : '' }}>
                                Penthouse</option>
                        </select>
                    </div>
                    ...
                    <!-- Build Year Fields -->
                    <div class="">
                        <label for="build-year" class="block text-md font-semibold text-[#374958]">Build Year:<sup
                                class="text-red-500 text-md ">*</sup></label>
                        <div class="flex">
                    ...
                    <div>
                        <label for="area" class="block text-md font-semibold text-[#374958]">Area (sq ft):<sup
                                class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="bedrooms" class="block text-md font-semibold text-[#374958]"> Bedrooms:<sup
                                class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="bathrooms" class="block text-md font-semibold text-[#374958]"> Bathrooms:<sup
                                class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="hall_rooms" class="block text-md font-semibold text-[#374958]"> Hall Rooms:<sup
                                class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="total_rooms" class="block text-md font-semibold text-[#374958]"> Total Rooms:</label>
                        <input type="number" min="0" id="total_rooms" name="total_rooms"
                            class="bg-gray-50 mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>

                    <div>
                        <label for="house_facing" class="block text-md font-semibold text-[#374958]">House Facing:<sup
                                class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="number_of_floors" class="block text-md font-semibold text-[#374958]">Number of
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mt-6 gap-4">
                    <div class="ward_no">
                        <label for="ward_no" class="block text-md font-semibold text-[#374958]"> Ward :</label>
                    ...
                    <div class="address_area mb-6">
                        <label for="address_area" class="block text-md font-semibold text-[#374958]"> Address Area
                            :</label>
                ...
                <!-- Amenities -->
                <div class="mb-6">
                    <label for="amenities" class="block text-md font-semibold text-[#374958]">Amenities:</label>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-2 text-[#2a3844] ml-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Car Parking Spaces -->
                    <div>
                        <label for="car_parking" class="block text-md font-semibold text-[#374958]">Car Parking
                    ...
                    <!-- Bike Parking Spaces -->
                    <div>
                        <label for="bike_parking" class="block text-md font-semibold text-[#374958]">Bike Parking
                            Spaces:<sup class="text-red-500 text-md ">*</sup></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <!-- Single Image Upload -->
                    <div class="mb-6">
                        <label for="image" class="block text-md font-semibold text-[#374958]">Upload Image:<sup
                                class="text-red-500 text-md">*</sup></label>
                        <input type="file" id="image" name="property_photo" accept="image/*"
                            class="bg-gray-50 mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        <small class="text-gray-500">Upload a Image of the property.</small>
                    </div>


                    <div>
                        <label for="video" class="block text-md font-semibold text-[#374958]">Property Video:</label>
                ...
                <!-- Description -->
                <div class="mb-6">
                    <label for="description" class="block text-md font-semibold text-[#374958]">Description:</label>
