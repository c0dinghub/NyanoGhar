        ...
        <div class="container mx-auto  p-8 max-w-6xl ">
            ...
            <form id="propertyForm" action="{{ route('storeProperty') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="title" class="block text-md font-semibold text-[#374958] ">Property Title:<sup class="text-red-500 text-md ">*</sup> </label>
                    ...
                    <div>
                        <label for="status" class="block text-md font-semibold text-[#374958]">Status:<sup class="text-red-500 text-md ">*</sup></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="property_type" class="block text-md font-semibold text-[#374958]">Property Type:<sup class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div id="houseFields" class="hidden">
                        <label for="house_category" class="block text-md font-semibold text-[#374958]">House Category:<sup class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div id="apartmentFields" class="hidden">
                        <label for="apartment_name" class="block text-md font-semibold text-[#374958]">Apartment Name:</label>
                        ...
                        <label for="apartment_category" class="block text-md font-semibold text-[#374958] mt-4">Apartment Category:<sup class="text-red-500 text-md ">*</sup></label>
                    ...
                    <!-- Build Year Fields -->
                    <div class="">
                        <label for="build-year" class="block text-md font-semibold text-[#374958]">Build Year:<sup class="text-red-500 text-md ">*</sup></label>
                        <div class="flex">
                    ...
                    <div>
                        <label for="area" class="block text-md font-semibold text-[#374958]">Area (sq ft):<sup class="text-red-500 text-md ">*</sup></label>
                        <input type="number" min="0" id="property_area" name="property_area"
                            class="bg-gray-50 mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>

                    <div>
                        <label for="bedrooms" class="block text-md font-semibold text-[#374958]"> Bedrooms:<sup class="text-red-500 text-md ">*</sup></label>
                        <input type="number" min="0" id="bedrooms" name="bedrooms"
                            class="bg-gray-50 mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>

                    <div>
                        <label for="bathrooms" class="block text-md font-semibold text-[#374958]"> Bathrooms:<sup class="text-red-500 text-md ">*</sup></label>
                        <input type="number" min="0" id="bathrooms" name="bathrooms"
                            class="bg-gray-50 mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>

                    <div>
                        <label for="hall_rooms" class="block text-md font-semibold text-[#374958]"> Hall Rooms:<sup class="text-red-500 text-md ">*</sup></label>
                    ...
                    <div>
                        <label for="house_facing" class="block text-md font-semibold text-[#374958]">House Facing:<sup class="text-red-500 text-md ">*</sup></label>
                ...
                <div  class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mt-6 gap-4">
                    ...
                    <div class="address_area mb-6">
                        <label for="address_area" class="block text-md font-semibold text-[#374958]"> Address Area :</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Car Parking Spaces -->
                    <div>
                        <label for="car_parking" class="block text-md font-semibold text-[#374958]">Car Parking Spaces:<sup class="text-red-500 text-md ">*</sup></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <!-- Image Upload -->
                    <div class="mb-6">
                        <label for="image" class="block text-md font-semibold text-[#374958]">Upload Image:<sup class="text-red-500 text-md ">*</sup></label>
