                    ...
                    <form action="{{ route('properties.search') }}" method="GET" class="grid grid-cols-1 gap-4">
                        ...
                        <div class="">
                            ...
                            <select id="status" name="status"
                                class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 ease-in-out" onchange="toggleBudgetOptions()">
                   ...
                   @endif
                    ...
                    @else
                        ...
                        @foreach ($properties as $property)
                            <div class="md:w-full bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row mb-4">
                                <!-- Property Image -->
                                ...
                                <div class="md:w-1/2 p-6 flex flex-col">
                                    ...
                                    @endif
                                    <p class="text-gray-600 mb-4 flex items-center"><ion-icon name="map" class="mr-2"></ion-icon>{{ $property->address_area }}, {{ $property->district?->district_en }}</p>
        ...
        <section class=" py-2">
            <div class="container1 mx-auto px-4 h-32">
                <div class="bg-orange-500 shadow-lg flex items-center p-10 justify-between text-center h-full">
                    ...
                    <a href="{{route('propertyPage')}}" class="bg-white text-orange-500 py-3 px-4 flex items-center justify-center hover:bg-gray-800 hover:text-white transition-transform duration-200 hover:scale-105">
