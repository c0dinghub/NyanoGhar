                    ...
                    <div class="flex justify-between px-6 py-2">
                        <div class="flex flex-col items-start">
                            ...
                            @if ($property->sale_price)
                                <p class="text-lg text-[#f5663b] font-semibold mb-2">Rs
                            ...
                            @endif
                            <p>
                                {{ $property->address_area }}, {{ $property->district->district_en }}
                            </p>
                        ...
                        <div class="flex justify-center items-end flex-col mb-2 ">
                            <div class="items-center">
                                <p>Assigned Agent:
                                    {{ $property->agent ? $property->agent->name : 'Not Assigned' }}</p>
                                <p>Email: {{ $property->agent ? $property->agent->email : 'N/A' }}</p>
                                <p>Phone: {{ $property->agent ? $property->agent->phone : 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Slider Images -->
